...
New-Item -ItemType SymbolicLink -Value D:\synology\dotfiles\files\games\csgo\warmup.cfg -Path 'C:\Program Files (x86)\Steam\userdata\28059286\730\local\cfg\warmup.cfg'
